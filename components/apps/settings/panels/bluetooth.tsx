...
const myDevicesDesktop: BluetoothDevice[] = [
  { name: "Amirah's Magic Keyboard", connected: true, battery: 91, type: "keyboard" },
  { name: "Amirah's Magic Trackpad", connected: true, battery: 20, type: "trackpad" },
  { name: "Nothing Headphones", connected: false, type: "headphones" },
  { name: "Amirah's AirPods Max", connected: false, type: "airpods-max" },
  { name: "Amirah's AirPods Pro", connected: false, type: "airpods" },
  { name: "Flipper Reg0l1", connected: false, type: "headphones" },
];

const myDevicesMobile = [
  { name: "Nothing Headphones", connected: true },
  { name: "Amirah's AirPods Max", connected: false },
  { name: "Amirah's AirPods Pro", connected: false },
    ...
    return (
      <div className="px-4 py-4 space-y-4">
        ...
        <p className="text-sm text-muted-foreground px-2">
          This iPhone is discoverable as &quot;amirah&apos;s iphone&quot; while Bluetooth Settings is open.
        </p>
      ...
      {bluetoothEnabled && (
        <>
          ...
          <p className="text-xs text-muted-foreground py-4 border-b border-border/50">
            This Mac is discoverable as &quot;Amirah&apos;s MacBook Air&quot; while Bluetooth Settings is open.
          </p>
